...
import pl.cyfronet.s4e.scenarios.production.GeoServerSentinelDBScenario

import scala.concurrent.duration._

class GeoServerSentinelDB extends Simulation {
  ...
  val scenario = new GeoServerSentinelDBScenario().getScenario
